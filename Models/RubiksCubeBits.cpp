...
class RubiksCubeBits : public Baserubiks {
...
public:
    ...
    bool operator==(const RubiksCubeBits &r1) const {
        for (int i = 0; i < 6; i++) {
    ...
    RubiksCubeBits &operator=(const RubiksCubeBits &r1) {
        for (int i = 0; i < 6; i++) {
...
struct HashBitboard {
    size_t operator()(const RubiksCubeBits &r1) const {
